    ...
    <AnimatePresence>
      {isResumeOpen && (
        ...
        >
          ...
          >
            {/* ─── Header Bar ─── */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200 shrink-0 no-print select-none">
              {/* Left — File info */}
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-gray-400">Dhruvi_Mittal_Resume.pdf</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={closeResume}
                  className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all duration-150 cursor-pointer"
            ...
            <div className="flex-1 min-h-0 overflow-auto bg-gray-100 flex justify-center p-3">
              <div className="shadow-lg bg-white rounded-sm overflow-hidden self-start">
